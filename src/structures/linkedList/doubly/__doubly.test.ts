//#region>Meta
/**
 * @file src/structures/linkedList/doubly/__doubly.test.ts
  ...
  describe('Node Operations', () => {
    ...
    describe('Insertion', () => {
      ...
      it('insert by index', () => {
        ...
        list.insert({ indexOrId: 1, node: { id: 'node2', data: { value: 2 } } });
        expect(list.size).toBe(3);
      });
      describe('insert by id', () => {
        it('inserts before a node by ID', () => {
          ...
          list.insert({ indexOrId: 'id-b', node: { data: 'X', id: 'id-x' }, position: 'before' });
        ...
        it('inserts after a node by ID', () => {
          ...
          list.insert({ indexOrId: 'id-b', node: { data: 'Y', id: 'id-y' }, position: 'after' });
        ...
        it('inserts before the head node by ID', () => {
          ...
          list.insert({ indexOrId: 'id-a', node: { data: 'Z', id: 'id-z' }, position: 'before' });
        ...
        it('inserts after the tail node by ID', () => {
          ...
          list.insert({ indexOrId: 'id-b', node: { data: 'W', id: 'id-w' }, position: 'after' });
