//#region>Meta
/**
 * @file src/structures/linkedList/types.ts
...
abstract class LinkedList<T, N extends DataNode.Instance<T>> {
  ...
  *forward(): ListIterator<N> {
  ...
  abstract find(id: string, direction?: TraversalDirection): { node: N; index: number } | undefined;
  ...
  abstract moveToTarget(nodeToMoveId: string, targetNodeId: string, position: InsertPosition): this;
  abstract toString(): string;
  abstract reset(): this;
  abstract getIndex(id: string): number | undefined;
  abstract pop(): N | undefined;
}
type ListAPIIterator<T> = Generator<{ data: T; id: string; index: number }, void, unknown>;
